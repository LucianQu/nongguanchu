...
public class DeviceStatusListActivity extends BaseActivity {
    ...
    private void getExtrasMapData() {
        ...
        if(null == bundle) {
            ...
            if (m_wdStatusBean == null) {
                m_title = (TextView) findViewById(R.id.wellinfo_tvw_title) ;
                m_title.setText(bundle.getString("wellInfoWellName"));
                setTitleRightViewVisibility(View.INVISIBLE) ;
            }
        }
    }
    ...
    private void setupView() {
        m_title = (TextView) findViewById(R.id.wellinfo_tvw_title) ;
        m_title.setText(m_wdStatusBean.getWellName());
        setTitleRightViewVisibility(View.INVISIBLE) ;
